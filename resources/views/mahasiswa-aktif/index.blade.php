<x-app-layout>
    ...
    <div class="p-4 bg-white rounded-lg shadow-xs">
      ...
      <div class="flex justify-end mb-4">
        <a href="{{ route('mahasiswa-aktif.create') }}"
        ...
        <a href="{{ route('mahasiswa-aktif.report') }}" target="_blank"
        ...
        <div class="overflow-x-auto w-full">
          <table class="w-full whitespace-no-wrap">
            ...
            <tbody class="bg-white divide-y">
              @forelse ($mahasiswaAktifs as $mhs)
                <tr class="text-gray-700">
                  ...
                  <td class="px-4 py-3 text-sm flex space-x-2">
                    ...
                    <a href="{{ route('mahasiswa-aktif.edit', $mhs->id) }}"
                    ...
                    <a href="{{ route('mahasiswa-aktif.report-by-id', $mhs->id) }}" target="_blank"
                          ...
                          <div class="mt-4 mb-6">
                            ...
                            <p class="text-sm text-gray-700">
                              Apakah Anda yakin ingin menghapus data <span
                                class="font-semibold">{{ $mhs->nomor_surat }}</span>?
                            </p>
                          </div>
                          <footer
                            ...
                            <form action="{{ route('mahasiswa-aktif.destroy', $mhs->id) }}" method="POST">
                              @csrf
                              @method('DELETE')
                              <button type="submit"
                      ...
                      <div x-show="openVerify" x-transition:enter="transition ease-out duration-150"
                        ...
                        <div x-show="openVerify" x-transition:enter="transition ease-out duration-150"
                          ...
                          <footer
                            ...
                            <form action="{{ route('mahasiswa-aktif.verify', $mhs->id) }}" method="POST">
                              @csrf
                              @method('PATCH')
                              <button type="submit"
                      ...
                      <div x-show="openReject" x-transition:enter="transition ease-out duration-150"
                        ...
                        <div x-show="openReject" x-transition:enter="transition ease-out duration-150"
                          ...
                          <footer
                            ...
                            <form action="{{ route('mahasiswa-aktif.reject', $mhs->id) }}" method="POST">
                              @csrf
                              @method('PATCH')
                              <button type="submit"
                                class="w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-red-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-red">
