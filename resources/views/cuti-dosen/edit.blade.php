<x-app-layout>
    <x-slot name="header">
        {{ __('Edit Data Pengajuan Cuti Dosen') }}
    </x-slot>
            ...
            <div class="grid grid-cols-1 gap-4 mt-2 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="nomor_surat" id="nomor_surat"
                        ...
                        value="{{ $cutiDosen->nomor_surat }}" readonly>
                </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="alasan_cuti" id="alasan_cuti" rows="4"
                        class="mt-2 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('alasan_cuti', $cutiDosen->alasan_cuti) }}</textarea>
                    @error('alasan_cuti')
