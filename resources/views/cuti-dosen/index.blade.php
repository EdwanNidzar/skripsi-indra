<x-app-layout>
  ...
  <div class="p-4 bg-white rounded-lg shadow-xs">
    ...
    <div class="flex justify-end mb-4">
      <a href="{{ route('cuti-dosen.create') }}"
      ...
      <a href="{{ route('cuti-dosen.report') }}" target="_blank"
            ...
            @forelse ($cutiDosen as $data)
              <tr class="text-gray-700">
                ...
                <td class="px-4 py-3 text-sm flex space-x-2">
                  <a href="{{ route('cuti-dosen.show', $data->id) }}"
                  ...
                  <a href="{{ route('cuti-dosen.edit', $data->id) }}"
                  ...
                  <a href="{{ route('cuti-dosen.report-by-id', $data->id) }}" target="_blank"
                    ...
                    <div x-show="openDelete" x-transition:enter="transition ease-out duration-150"
                      ...
                      <div x-show="openDelete" x-transition:enter="transition ease-out duration-150"
                        ...
                        <footer
                          ...
                          <form action="{{ route('cuti-dosen.destroy', $data->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
                    ...
                    <div x-show="openVerify" x-transition:enter="transition ease-out duration-150"
                      ...
                      <div x-show="openVerify" x-transition:enter="transition ease-out duration-150"
                        ...
                        <footer
                          ...
                          <form action="{{ route('cuti-dosen.verify', $data->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <button type="submit"
                    ...
                    <div x-show="openReject" x-transition:enter="transition ease-out duration-150"
                      ...
                      <div x-show="openReject" x-transition:enter="transition ease-out duration-150"
                        ...
                        <footer
                          ...
                          <form action="{{ route('cuti-dosen.reject', $data->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <button type="submit"
                              class="w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-red-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-red">
