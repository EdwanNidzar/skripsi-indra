  ...
  <div class="p-4 bg-white rounded-lg shadow-xs">
    <form action="{{ route('pkl.update', $pkl->id) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
        ...
        {{-- nomor_surat hidden --}}
        <input type="hidden" name="nomor_surat" value="{{ $pkl->nomor_surat }}">
        ...
        <div class="sm:col-span-1">
          ...
          @if ($pkl->bukti_pembayaran)
            <p class="mt-2 text-sm text-gray-500">Bukti saat ini: <a href="{{ asset('storage/pkl/bukti_pembayaran/' . $pkl->bukti_pembayaran) }}">Liat bukti pembayaran</a></p>
          @endif
        </div>
        ...
        <div class="sm:col-span-1">
          ...
          @if ($pkl->surat_pernyataan)
            <p class="mt-2 text-sm text-gray-500">Surat saat ini: <a href="{{ asset('storage/pkl/surat_pernyataan/' . $pkl->surat_pernyataan) }}">Liat surat pernyataan</a></p>
          @endif
        </div>
