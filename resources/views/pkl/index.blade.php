            ...
            <tbody class="bg-white divide-y">
              @forelse ($pkl as $data)
                <tr class="text-gray-700">
                  ...
                  <td class="px-4 py-3 text-sm">
                    <a href="storage/pkl/bukti_pembayaran/{{ $data->bukti_pembayaran }}" target="_blank" class="underline text-blue-500">Lihat Bukti Pembayaran</a>
                  </td>
                  <td class="px-4 py-3 text-sm">
                    <a href="storage/pkl/surat_pernyataan/{{ $data->surat_pernyataan }}" target="_blank" class="underline text-blue-500">Lihat Surat Pernyataan</a>
                  </td>
                  <td class="px-4 py-3 text-sm">
                    {{ $data->status }}
                  </td>
