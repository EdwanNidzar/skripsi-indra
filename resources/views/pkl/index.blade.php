<x-app-layout>
  ...
  <div class="p-4 bg-white rounded-lg shadow-xs">
    ...
    <div class="flex justify-end mb-4">
      ...
      <a href="{{ route('pkl.report') }}" target="_blank"
        class="flex items-center px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-gray-600 border border-transparent rounded-lg active:bg-gray-600 hover:bg-gray-700 focus:outline-none focus:shadow-outline-gray">
          ...
          <tbody class="bg-white divide-y">
            @forelse ($pkl as $data)
              <tr class="text-gray-700">
                ...
                <td class="px-4 py-3 text-sm">
                  <a href="storage/pkl/bukti_pembayaran/{{ $data->bukti_pembayaran }}" target="_blank"
                    class="underline text-blue-500">Lihat Bukti Pembayaran</a>
                </td>
                <td class="px-4 py-3 text-sm">
                  <a href="storage/pkl/surat_pernyataan/{{ $data->surat_pernyataan }}" target="_blank"
                    class="underline text-blue-500">Lihat Surat Pernyataan</a>
                </td>
                <td class="px-4 py-3 text-sm">
                  {{ $data->status }}
                </td>
                <td class="px-4 py-3 text-sm flex space-x-2">
                  <a href="{{ route('pkl.show', $data->id) }}"
                  ...
                  <a href="{{ route('pkl.report-by-id', $data->id) }}" target="_blank"
                    ...
                    <div x-show="openDelete" x-transition:enter="transition ease-out duration-150"
                      ...
                      <div x-show="openDelete" x-transition:enter="transition ease-out duration-150"
                        ...
                        <footer
                          ...
                          <form action="{{ route('pkl.destroy', $data->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
                  ...
                  <div x-data="{ openVerify: false }" class="inline">
                    ...
                    <div x-show="openVerify" x-transition:enter="transition ease-out duration-150"
                      ...
                      <div x-show="openVerify" x-transition:enter="transition ease-out duration-150"
                        ...
                        x-transition:leave="transition ease-in duration-150"
                        x-transition:leave-start="opacity-100 transform translate-y-0"
                        x-transition:leave-end="opacity-0 transform translate-y-1/2" @click.away="openVerify = false"
                        ...
                        <footer
                          ...
                          <form action="{{ route('pkl.verify', $data->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <button type="submit"
                  ...
                  <div x-data="{ openReject: false }" class="inline">
                    ...
                    <div x-show="openReject" x-transition:enter="transition ease-out duration-150"
                      ...
                      <div x-show="openReject" x-transition:enter="transition ease-out duration-150"
                        ...
                        x-transition:leave="transition ease-in duration-150"
                        x-transition:leave-start="opacity-100 transform translate-y-0"
                        x-transition:leave-end="opacity-0 transform translate-y-1/2" @click.away="openReject = false"
                        ...
                        <footer
                          ...
                          <form action="{{ route('pkl.reject', $data->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <button type="submit"
                              class="w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-red-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-red">
